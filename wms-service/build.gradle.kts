...
dependencies {
    ...
    // Barcode/RFID
    implementation("org.springframework.boot:spring-boot-starter-barcode4j")
...
application {
    mainClass.set("com.logi.wms.LogiWmsApplication")
}

tasks.named("bootJar") {
    archiveFileName.set("logi-wms-service.jar")
}
